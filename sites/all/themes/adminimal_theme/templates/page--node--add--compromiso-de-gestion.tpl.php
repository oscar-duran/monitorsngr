  ...
  <div id="content-wrapper">
    ...
    <div id="main-content">
	    ...
	    <?php
            ...
            print render($page['content']['system_main']['field_estado']);
            print render($page['content']['system_main']['field_accion_a_seguir']);
            print render($page['content']['system_main']['field_item_compromiso']);
